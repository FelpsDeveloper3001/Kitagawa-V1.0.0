...
module.exports = {
    name: "emoji", 
    description: "[📕Info] Veja informações de um emoji.", 
        ...
        if (!emoji) {
            interaction.reply({
                embeds: [
                    ...
                    .setColor("#FF00FF")
                    .setDescription(`**<:ix:1050213485700710541> - Não encontrei o emoji, siga o modelo abaixo**\n\`/emoji-info [nome]\``)
                ]
            });
        } else if (emoji) {
            try {
            ...
            interaction.reply(`<:ix:1050213485700710541> Houve um erro ao tentar utilizar esse comando, ${interaction.user}`)
        }
